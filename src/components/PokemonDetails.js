...
function PokemonDetails() {
  ...
  return (
    <div className='flex justify-center items-center py-10 flex-row gap-24'>
      ...
      <div className='flex justify-center items-center flex-col gap-5 w-80 h-full' >
          <div className={`${types && Types[types[0].name]} flex justify-center items-center flex-row w-80 rounded-2xl shadow-gray-700 shadow-md relative`}>
            <button className={` ${num === 0 ? "hidden":""} absolute top-1/3 left-1 bg-gray-400 opacity-80 rounded-lg hover:bg-gray-300 duration-150 hover:scale-110 h-28 w-10 hover:text-red-600 text-white`} onClick={() => setNum(0)} ><i className="fa-solid text-3xl  fa-caret-left "></i></button>
            <img alt={name} className='h-80' src={sprites && sprites[num]}/>
            <button className={`${num === 1 ? "hidden":""} absolute top-1/3 right-1 bg-gray-400 opacity-80 rounded-lg hover:bg-gray-300 duration-150 hover:scale-110 h-28 w-10 hover:text-red-600 text-white `} onClick={() => setNum(1)}><i className="fa-solid text-3xl  fa-caret-right "></i></button>
          </div>
      ...
      <div className='flex- justify-center items-center flex-col bg-zinc-700 px-10 py-5 rounded-2xl gap-5 shadow-md shadow-gray-700'>
        <div className='flex justify-center items-center flex-col w-80'>
          ...
          <div className='flex justify-center items-center flex-col gap-3 p-4 '>
                  ...
                  <div className=" h-8 w-80 overflow-hidden rounded-sm relative flex justify-center items-center" >
                  ...
                  <p  className='top-0 left-0 absolute bg-gray-400 w-80 h-8' ></p>
                  </div>
                  <div className=" h-8 w-80 overflow-hidden rounded-sm relative flex justify-center items-center" >
